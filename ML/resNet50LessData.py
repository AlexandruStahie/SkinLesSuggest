...
validateSet = pd.concat([validateSet, melanocyticNevi[:150]])

# 332 add to train, dropping 3k nevi values
train2 = pd.concat([train2, melanocyticNevi[151:len(melanocyticNevi)]])
